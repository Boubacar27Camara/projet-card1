...
const handleSubmit = (event) => {
    event.preventDefault() // ca va empecher le rafrechissement de la page
    const formTitle = document.querySelector('#project-title').value// document c'est une representation votre html au format javascript.  
